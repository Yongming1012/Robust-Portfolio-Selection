...
save('../Result/Real_KL(d=0.1).mat', 'average_cost', 'cost_array', 'portfolio_classical', 'portfolio_robust', 'relative_cost', 't_array', 'wealth_classical', 'wealth_n', 'wealth_robust');
